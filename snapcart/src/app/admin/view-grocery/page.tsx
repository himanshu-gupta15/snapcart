...
import { IGrocery } from "@/model/grocery.models";
  ...
  return (
    <div className="pt-4 w-[95%] md:w-[85%] mx-auto pb-20">
      ...
      >
       ...
       <h1 className="text-2xl md:text-3xl font-extrabold text-green-700 flex items-center justify-center gap-2"><Package size={28} className="text-green-600"/>Manage Grogeries</h1>
      </motion.div>
      <motion.form
        ...
        {editing &&(
         ...
         >
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button className="px-4 py-2 rounded-lg bg-red-600 text-white flex items-center gap-2 hover:bg-red-700 transition-all" onClick={handleDelete} disabled={loading1}>
              {loading1?<Loader size={14}/>:"Delete Grocery"}
            </button>
          </div>
         </motion.div>
