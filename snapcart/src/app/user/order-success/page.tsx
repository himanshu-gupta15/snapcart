...
function OrderSuccess() {
  return (
    <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
      ...
      >
        <div className='w-full h-full rounded-full bg-green-700 blur-2'></div>
      </motion.div>
      </motion.div>
      <motion.h1
    ...
    Order Placed Successfully
      ...
      >
        Thank you for shopping with us! Your order has been placed and is being processed. You can track its progress in your <span className='font-semibold text-green-700'>My Orders</span> secton.
      </motion.p>
      <motion.div
      ...
      >
       ...
       whileTap={{scale:0.93}}
       className='flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-base font-semibold px-8 y-3 rounded-full shadow-lg transition-all'
       >
