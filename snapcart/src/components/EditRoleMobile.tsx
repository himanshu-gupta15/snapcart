  ...
  return (
    <div className='flex flex-col min-h-screen p-6 w-full items-center'>
      ...
      >
        ...
        <input type='tel' id='mobile' className='w-64 md:w-80 px-4 p-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-green-500 focus:outline-none text-gray-800'
